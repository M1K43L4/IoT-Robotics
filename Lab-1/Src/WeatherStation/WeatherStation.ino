...
#define IO_USERNAME  "umkciot"
#define IO_PASS "umkciot"
#define IO_KEY  "15c77b3f32b5414b8a26b0baf58f769e"

#include <LiquidCrystal_PCF8574.h>
#include <DHT.h>
# include <Adafruit_MQTT.h> // use adafruit_MQTT for constant updates
...
#define IP "52.7.124.212"// io.adafruit.com ip
String msg = "GET /update?key=74MPY9YTSE43ZA3H"; //change it with your api key like "GET /update?key=Your Api Key"
